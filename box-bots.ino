...
#define   lpin1   5     // left control pin one is pin 4
#define   lpin2   4     // left control pin two is pin 5
...
#define   rpwm    9     // pulse width modulation for right motor is pin 9 for new board 
